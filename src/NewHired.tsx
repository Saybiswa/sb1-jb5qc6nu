...
const goToVideo = (topic: string) => {
  navigate(`/training/new-hired-training/${topic}`);
};
    ...
    <div className="training-page">
      ...
      <div className="modules-container">
        <div className="module-card">
          <h2>Module 1 – About LG [4]</h2>
          <div className="module-content">
            <div className="day-section">
              <h3>Day 1 </h3>

<ul className="topic-list">
  <li onClick={() => goToVideo("lg-history")}>
    LG History
  </li>

  <li onClick={() => goToVideo("department-overview")}>
    All Department Overview, Products
  </li>

  <li onClick={() => goToVideo("cs-intro")}>
    CS Intro
  </li>

  <li onClick={() => goToVideo("cic-intro")}>
    CIC Introduction
  </li>
</ul>
            ...
            <div className="day-section">
              <h3>Day 2 GSFS [7]</h3>
              <ul>
                <li>GSFS  Introduction </li>
                <li>Fresh Call Registration </li>
                <li>GSFS Explanation CNP</li>
                <li>Call Re-Registration</li>
                <li>Oneview</li>
                <li>Reminder Generation  </li>
                <li>VOC</li>
              </ul>
            </div>
            <div className="day-section">
